...
const AI_TIERS: Record<string, ModelTierConfig> = {
  'AI-1': {
    cheap: { provider: 'doubao', model: 'ep-doubao-pro-32k', costPer1kTokens: 0.0001 },
    premium: { provider: 'doubao', model: 'ep-doubao-pro-256k', costPer1kTokens: 0.0007 },
  },
  'AI-2': {
    cheap: { provider: 'gemini', model: 'gemini-2.5-flash-lite', costPer1kTokens: 0.00005 },
    premium: { provider: 'gemini', model: 'gemini-2.5-flash', costPer1kTokens: 0.0003 },
  },
  'AI-3': {
